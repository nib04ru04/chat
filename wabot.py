...
class WABot:
    def __init__(self):
        ...
        json_url = os.path.join(site_root, "static/setting", "chatapi.json")
        data = json.load(open(json_url))
        # return render_template('showjson.jade', setting=setting)
        # self.json = json
        # self.dict_messages = json['messages']
        self.APIUrl = f"https://eu41.chat-api.com/instance{ data['instance'] }/"
